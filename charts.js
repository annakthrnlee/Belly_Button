...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      title: "Top 10 Bacteria Cultures Found in Your Belly Button",
      yaxis: {
        tickmode: "array",
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'This bar chart shows the most abundant bacterial species (OTUs)<br> found in your belly button',
        showarrow: false
      }]
    };
    //console.log("hello");
